...
const Input = ({ placeholder, name, type, value, handleChange }) => (
  <input 
    ...
    className='my-2 w-full rounded p-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism'
  />
)
      ...
      <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-20 px-4">
        <div className="flex flex-1 justify-start flex-col md:mr-10">
          ...
          <p className='text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base'>
            Explore the crypto world. Buy and sell cryptocurreny easily on Krypto.
          </p>
          <button
            type='button'
        ...
        <div className='flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10'>
          <div className='p-3 juste4
           items-start rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism'>
